...
class __TwigTemplate_d0d599cba84e3671a7c2858777f46864e895625e082a7e727c55a73e25a2e69f extends Twig_Template
{
    ...
    ";
        ...
        if ((isset($context["is_modal"]) ? $context["is_modal"] : null)) {
            ...
            <div class=\"mediapicker-scroll\">
                ";
            // line 14
            $this->loadTemplate("partials/media-list-wrapper__list.html.twig", "partials/media-list-wrapper.html.twig", 14)->display(array_merge($context, array("is_modal" => (isset($context["is_modal"]) ? $context["is_modal"] : null))));
            // line 15
            echo "            </div>
    ...
    ";
            ...
            if ( !(isset($context["route"]) ? $context["route"] : null)) {
                ...
                ";
                // line 25
                $this->loadTemplate("partials/media-list-wrapper__list.html.twig", "partials/media-list-wrapper.html.twig", 25)->display(array_merge($context, array("is_modal" => (isset($context["is_modal"]) ? $context["is_modal"] : null))));
                // line 26
                echo "
            ";
            } else {
    ...
    {% endif %}
</div>", "partials/media-list-wrapper.html.twig", "C:\\Program Files (x86)\\Ampps\\www\\ThemeGrav\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\media-list-wrapper.html.twig");
    }
}
