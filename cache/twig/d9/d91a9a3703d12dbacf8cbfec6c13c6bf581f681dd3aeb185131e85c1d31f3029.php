...
class __TwigTemplate_2c3651b48bcb214d706b518565c40521bb0d61465593fca3159cd7f3dd4cdcf4 extends Twig_Template
{
    ...
    <div class=\"filter-wrapper filter-type\">
        <select class=\"filter js__filter\" data-name=\"type\" data-grav-selectize>
            <option value=\"*\" ";
        // line 4
        if ( !$this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "uri", array()), "param", array(0 => "type"), "method")) {
            echo "selected";
        }
        echo ">All Files</option>
            <option value=\"images\" ";
        // line 5
        if (($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "uri", array()), "param", array(0 => "type"), "method") == "images")) {
            echo "selected";
        }
        echo ">Images</option>
            <option value=\"videos\"";
        // line 6
        if (($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "uri", array()), "param", array(0 => "type"), "method") == "videos")) {
            echo "selected";
        }
        echo ">Videos</option>
            <option value=\"audios\"";
        // line 7
        if (($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "uri", array()), "param", array(0 => "type"), "method") == "audios")) {
            echo "selected";
        }
        echo ">Audio</option>
            <option value=\"files\"";
        // line 8
        if (($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "uri", array()), "param", array(0 => "type"), "method") == "files")) {
            echo "selected";
        }
        echo ">Files</option>
        </select>
    ...
    <div class=\"filter-wrapper filter-date\">
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "filesDates", array()));
        foreach ($context['_seq'] as $context["year"] => $context["months"]) {
            ...
            foreach ($context['_seq'] as $context["month"] => $context["number"]) {
                ...
                echo "\" ";
                if (($this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "uri", array()), "param", array(0 => "date"), "method") == (($context["year"] . "-") . $context["month"]))) {
                    echo "selected";
                }
                echo ">
                            ";
                // line 20
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["theDate"]) ? $context["theDate"] : null), "setDate", array(0 => $this->getAttribute((isset($context["theDate"]) ? $context["theDate"] : null), "format", array(0 => "Y"), "method"), 1 => $context["month"], 2 => $this->getAttribute((isset($context["theDate"]) ? $context["theDate"] : null), "format", array(0 => "d"), "method")), "method"), "M"), "html", null, true);
                echo "
                            (";
                // line 21
...
</div>", "partials/media-list-wrapper__list__filters.html.twig", "C:\\Program Files (x86)\\Ampps\\www\\ThemeGrav\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\media-list-wrapper__list__filters.html.twig");
    }
}
