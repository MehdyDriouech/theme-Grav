...
class __TwigTemplate_8bb8aa6b86814c9855342ca63fe3bf4bf59a13a05ebd54d4b0451ad506fb14a5 extends Twig_Template
{
    ...
    <h5>";
        // line 2
        echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.PAGES"));
        echo "</h5>
...
{% macro loop(page, depth, twig_vars) %}
    ...
    {% endfor %}
{% endmacro %}", "partials/media-list-wrapper__sidebar.html.twig", "C:\\Program Files (x86)\\Ampps\\www\\ThemeGrav\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\media-list-wrapper__sidebar.html.twig");
    }
}
