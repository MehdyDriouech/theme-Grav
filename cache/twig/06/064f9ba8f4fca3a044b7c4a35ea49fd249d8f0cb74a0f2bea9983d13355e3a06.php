...
class __TwigTemplate_9555d590aa357357b277b1eb025c5ec2ac3c097ddcd7b54e73b77e45b979bc71 extends Twig_Template
{
...
";
  ...
  <div class=\"header\">
    ...
    <img class=\"co-logo\" src=\"";
        // line 13
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["media"]) ? $context["media"] : null), "user://plugins/seo/assets/logofacebook.jpg", array(), "array"), "resize", array(0 => 50, 1 => 50), "method"), "url", array(), "method"), "html", null, true);
        echo "\" />
  ...
  <div class=\"reference\">
    <img class=\"reference-thumb\" id=\"liveimg\" src=\"";
        // line 22
        if ($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "header", array()), "facebookimg", array())) {
            echo twig_escape_filter($this->env, (isset($context["base_url_absolute"]) ? $context["base_url_absolute"] : null), "html", null, true);
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "header", array()), "facebookimg", array()), "html", null, true);
            echo " ";
        } else {
            echo " ";
...
function validatepage() {
 ...
 var validateurl = structuredurl + encodeURIComponent(host + targeturl);
   window.open(validateurl, '_blank')
    ...
    {% endif %}
", "forms/fields/facebook/facebook.html.twig", "C:\\Program Files (x86)\\Ampps\\www\\ThemeGrav\\user\\plugins\\seo\\templates\\forms\\fields\\facebook\\facebook.html.twig");
    }
}
