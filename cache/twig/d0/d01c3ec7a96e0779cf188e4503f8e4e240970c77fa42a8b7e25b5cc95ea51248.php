...
class __TwigTemplate_cc476cfbb08bc5f11dedb05c29db73a00cb44d5d2bcf725f002df409e83223d7 extends Twig_Template
{
    ...
    <section id=\"admin-login\" class=\"login-box-shadow ";
        ...
        ";
        // line 18
        $context["redirect"] = (((isset($context["redirect"]) ? $context["redirect"] : null)) ? ((isset($context["redirect"]) ? $context["redirect"] : null)) : (((("/" . (isset($context["admin_route"]) ? $context["admin_route"] : null)) . "/") . $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", array()))));
        // line 19
        echo "
...
{% endblock %}
", "partials/login.html.twig", "C:\\Program Files (x86)\\Ampps\\www\\grav-skeleton-agency-site\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\login.html.twig");
    }
}
