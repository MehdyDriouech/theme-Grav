...
class __TwigTemplate_ff0da34879dabff550cdbe3a617b5c6826935c00f92726f0c00c25e32c6c8c51 extends Twig_Template
{
    ...
    ";
        // line 6
        if (twig_test_empty($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "files", array()))) {
            // line 7
            echo "        <div class=\"empty-state\">
            ";
            // line 8
            if (($this->getAttribute((isset($context["uri"]) ? $context["uri"] : null), "param", array(0 => "type"), "method") || $this->getAttribute((isset($context["uri"]) ? $context["uri"] : null), "param", array(0 => "date"), "method"))) {
                // line 9
                echo "                <h2>Filtering by ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["uri"]) ? $context["uri"] : null), "param", array(0 => "type"), "method"), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["uri"]) ? $context["uri"] : null), "param", array(0 => "date"), "method"), "html", null, true);
                echo "</h2>
            ";
            }
            // line 11
    ...
    ";
            ...
            // line 17
            echo "        ";
            $this->loadTemplate("media-list-content.html.twig", "partials/media-list-wrapper__list.html.twig", 17)->display(array_merge($context, array("is_modal" => (isset($context["is_modal"]) ? $context["is_modal"] : null))));
            echo " ";
            // line 18
            echo "    ";
        }
...
", "partials/media-list-wrapper__list.html.twig", "C:\\Program Files (x86)\\Ampps\\www\\ThemeGrav\\user\\plugins\\admin\\themes\\grav\\templates\\partials\\media-list-wrapper__list.html.twig");
    }
}
